export class ListToDoPageLocators {
  ...
  static readonly addNewToDoButtonXpath = "//span[@class='MuiIconButton-label']";
  ...
  static readonly createNewToDoModalHeaderXpath = "//h2[@data-testid='sub-header']";
  static readonly createNewToDoFieldXpath = "//input[@class='MuiInputBase-input MuiOutlinedInput-input']";
  static readonly createNewToDoButtonXpath = "//button[@data-testid='submit-newTask']";
  static readonly goBackToToDoListButtonXpath = "//h2[@class='sc-ivTmOn jYMFSu']";
}
